...
@WebFilter(urlPatterns={"/member/create","/member/login"})
public class PublicOnlyFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		log.info("PublicOnlyFilter   >>  url :" +  requestUrl);
		...
		if(member != null) {
			...
			log.info("PublicOnlyFilter   >>  ACCESS DINIED AND sendRedirect :" +  ReferUrl);
			return;
		}
